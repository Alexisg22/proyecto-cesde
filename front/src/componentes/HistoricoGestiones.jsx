            ...
            <div className='cotenedorModal'>
                <div className='modalHistoricoGestiones'>
                    ...
                    <div className='datosAspiranteHistorico' >
                        {(historicoGestiones) && <p><strong>Aspirante: </strong>{historicoGestiones[0].nombre == 'nan' ? 'No asinado' : historicoGestiones[0].nombre}</p>}
                        {(historicoGestiones) && <p><strong>Celular: </strong>{historicoGestiones[0].celular == 'nan' ? 'No asinado' : historicoGestiones[0].celular}</p>}
                        {(historicoGestiones) && <p><strong>Programa: </strong>{historicoGestiones[0].programa == 'nan' ? 'No asinado' : historicoGestiones[0].programa}</p>}
                        {(historicoGestiones) && <p><strong>Sede: </strong>{historicoGestiones[0].sede == 'nan' ? 'No asignado' : historicoGestiones[0].sede}</p>}
                    </div>
                    <hr />
